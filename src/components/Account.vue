          ...
          <div class = "card mb-5">
            ...
            <div class = "card-content" v-show="expand">
              <div class="content">
                ...
                <div class = "block">
                  <p class = "title is-6 has-text-weight-bold">Name:</p>
                  <p class = "subtitle is-6">{{this.info.first_name}} {{this.info.last_name}}</p>
                </div>

                <div class = "block">
                  <p class = "title is-6 has-text-weight-bold">Email Address:</p>
                  <p class = "subtitle is-6">{{this.info.email_address}}</p>
                </div>

                <div class = "block">
                  <p class = "title is-6 has-text-weight-bold">Phone Number:</p>
